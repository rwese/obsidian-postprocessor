...
""")
    ...
    def test_templates_directory_ignored_capitalized(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            template_notes = [path for path in note_paths if path.startswith('templates/') or path.startswith('Templates/')]
    ...
    def test_should_ignore_note_method(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            assert detector._should_ignore_note('Nested Template') == True  # In subfolder/Templates/
