...
""")
        ...
        note2.write_text("""This note has no frontmatter.
...
""")
    ...
    def test_get_unprocessed_recordings(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            all_recordings = ['Recording001.webm', 'Recording002.mp3', 'Recording003.wav']
...
"""
    ...
    def test_get_processing_stats(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            notes_with_memos = {
                'Processed Note': ['Recording001.webm', 'Recording002.mp3', 'Recording003.wav'],
