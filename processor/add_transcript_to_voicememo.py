...
class VoiceMemoTranscriber:
    ...
    def _detect_language_from_filename(self, filename: str) -> Optional[str]:
        ...
        language_patterns = {
            '_en.': 'en', '_english.': 'en', '_eng.': 'en',
            '_de.': 'de', '_german.': 'de', '_deutsch.': 'de',
            '_fr.': 'fr', '_french.': 'fr', '_francais.': 'fr',
            '_es.': 'es', '_spanish.': 'es', '_espanol.': 'es',
            '_it.': 'it', '_italian.': 'it', '_italiano.': 'it',
            '_pt.': 'pt', '_portuguese.': 'pt', '_portugues.': 'pt',
            '_ru.': 'ru', '_russian.': 'ru',
            '_zh.': 'zh', '_chinese.': 'zh',
            '_ja.': 'ja', '_japanese.': 'ja',
            '_ko.': 'ko', '_korean.': 'ko',
    ...
    def transcribe_audio(self, audio_file_path: Path, language: Optional[str] = None, 
                        model: str = "small") -> str:
    ...
    def process_voice_memo(self, note_path: Path, voice_file_path: Path, 
                          language: Optional[str] = None, model: str = "small") -> bool:
...
def main():
    ...
    logger.info(f"Processing voice memo:")
